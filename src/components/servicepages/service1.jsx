...
function Services() {
    ...
    return (
        <div className="services">
            ...
            <br />
            <p className="justify">
                At Global Trader Events, we specialize in expert event organization tailored to your unique needs and vision. From intimate gatherings to large-scale productions, our dedicated team handles every detail with precision and professionalism. We offer comprehensive event planning services, including venue selection, logistics coordination, vendor management, and onsite support, ensuring a seamless and memorable experience for you and your guests. Whether you're planning a corporate conference, a wedding celebration, or a community fundraiser, trust Global Trader Events to bring your vision to life with creativity, expertise, and flawless execution.
            </p>
            <br />
